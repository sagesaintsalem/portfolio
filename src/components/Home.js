    ...
    return (
        <HomeDiv>
            ...
            <p>I originally was an aspiring academic and frequent volunteer before realising that that lifestyle was not for me. During the pandemic, I started to experiment with coding - Python, HTML, CSS, Bootstrap - and found that I not only enjoyed it, but that I was *good* at it. 
                ...
                and thus be able to secure a job in software development.</p>
            ...
            <p>I started at CodeClan in November 2022 and I have gone from having a small amount of coding knowledge to being able to build full-stack websites in a matter of weeks. 
                ...
                keeping my LinkedIn page up to date and building my portfolio site (psst - you’re already here!).</p>
